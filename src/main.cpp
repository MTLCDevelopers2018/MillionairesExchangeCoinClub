...
unsigned int nTargetSpacing = 64; // 64 sec
unsigned int nStakeMinAge = 14 * 60 * 60; // 14 hours
...
const string strMessageMagic = "MillionairesExchangeCoinClub Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MillionairesExchangeCoinClub", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "If we could sell our experiences for what they cost us, we'd all be millionaires.";
        CTransaction txNew;
        txNew.nTime = 1525091270;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525091270;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 54912 : 54912;

        assert(block.hashMerkleRoot == uint256("0x639cf6848782d6aedabfc8968eef11d7ce73b92daee8349371c3b6e00fcd2086"));
...
unsigned char pchMessageStart[4] = { 0x9a, 0xe1, 0xd3, 0xa9 };
